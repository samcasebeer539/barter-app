...
from routes.dev.trades.offer.route import trades_offer_bp
...
from routes.dev.feed.search.route import feed_search_bp
...
app.register_blueprint(trades_offer_bp)

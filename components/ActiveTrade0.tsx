                    ...
                    <View style={styles.leftRightButton}>
                      ...
                      >
                        <FontAwesome6 
                          name="caret-left" 
                          size={30} 
                          color={playerCardIndex === 0 ? colors.ui.secondarydisabled : '#fff'} 
                        />
                      </TouchableOpacity>
                      ...
                      >
                        <FontAwesome6 
                          name="caret-right" 
                          size={30} 
                          color={playerCardIndex === playercards.length - 1 ? colors.ui.secondarydisabled : '#fff'} 
                        />
                      </TouchableOpacity>
                    </View>
              </View>
                    ...
                    <View style={styles.leftRightButton}>
                      ...
                      >
                        <FontAwesome6 
                          name="caret-left" 
                          size={30} 
                          color={partnerCardIndex === 0 ? colors.ui.secondarydisabled : '#fff'} 
                        />
                      </TouchableOpacity>
                      ...
                      >
                        <FontAwesome6 
                          name="caret-right" 
                          size={30} 
                          color={partnerCardIndex === partnercards.length - 1 ?  colors.ui.secondarydisabled : '#fff'} 
                        />
                      </TouchableOpacity>
                    </View>
